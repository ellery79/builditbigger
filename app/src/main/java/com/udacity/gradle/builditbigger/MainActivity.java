...
class EndpointsAsyncTask extends AsyncTask<Context, Void, String> {
    ...
    protected void onPostExecute(String result) {
        if (!result.equals("")) {
            ...
            jokeIntent.setType("text/plain");
            Intent shareIntent = Intent.createChooser(jokeIntent, null);
            context.startActivity(shareIntent);
        } else {
            Toast.makeText(context, "no joke can be retrieved", Toast.LENGTH_SHORT).show();
        }
